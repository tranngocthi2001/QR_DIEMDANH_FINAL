                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Thông tin tài khoản</span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Tạo phản hồi</a>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <x-app-layout>
                        <x-slot name="header">
                            VUI LÒNG CLICK "LOG OUT" THÊM 1 LẦN NỮA ĐỂ ĐĂNG XUẤT.
                            <a href="{{ route('user.usershowQR') }}">Xem mã QR</a>
                         </x-slot>
                        </x-app-layout>
